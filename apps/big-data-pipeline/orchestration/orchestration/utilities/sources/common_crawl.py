...
def get_warc_record_stream(archive_stream: ArchiveIterator, dataset_id: str, filter_short_html=False):
    ...
    for record in archive_stream:
        ...
        try:
            ...
            total_attempts = failure_counter + success_counter

            if total_attempts > 0:
                failure_ratio = (failure_counter / total_attempts)
            else:
                failure_ratio = 0  # Avoid division by zero by setting a default value
